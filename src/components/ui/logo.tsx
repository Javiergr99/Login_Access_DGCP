...
export function Logo({ to = "/login" }: { to?: string }) {
  return (
    <Link
      to={to}
      className="focus-ring flex items-center gap-3 rounded-[var(--radius-sm)]"
      aria-label="Ecosistema Integral DGCP"
    >
      ...
      <span className="leading-tight">
        <strong className="block text-base text-[var(--color-text-primary)]">
